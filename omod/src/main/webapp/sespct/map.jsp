...
<openmrs:require privilege="Mapear pacientes no SESP-CT Interoperabilidade" otherwise="/login.htm" redirect="/module/sespct/manageftresults.form"/>
...
<h2>
    <openmrs:message code="sespct.map.identifiers"/>
</h2>
...
<div>
    ...
    <div class="box disaBox">
        <table id="disaPatient" class="disa-table disa-table-clear" width="100%">
            <thead>
            <tr>
                <th><spring:message code="sespct.table.nid"/></th>
                <th><spring:message code="sespct.table.initials"/></th>
                <th><spring:message code="sespct.table.age"/></th>
                <th><spring:message code="sespct.table.sex"/></th>
                <th></th>
            </tr>
            </thead>
            <tbody>
            <tr>
                ...
                <td>${pedido.dadosUtente.idade}</td>
                <td>${pedido.dadosUtente.sexo}</td>
                <td></td>
            </tr>
            </tbody>
        </table>
...
<div>
    <div class="boxHeader">
        ...
        <b>
            <spring:message code="sespct.openmrs.list.patients" />
        </b>
    </div>
    <div class="box">
        <form method="post">
            ...
            <table  id="patientListTable"  class="disa-table disa-table-clear" width="100%">
                ...
                <tr>
                    <th><spring:message code="sespct.table.nid"/></th>
                    <th><spring:message code="sespct.name"/></th>
                    <th><spring:message code="sespct.table.age"/></th>
                    <th><spring:message code="sespct.table.sex"/></th>
            ...
            <div class="submit-btn center">
                <button type="submit">
                    <spring:message code="sespct.btn.map"/>
                </button>
            </div>
        </form>
    </div>
...
<openmrs:htmlInclude file="${pageContext.request.contextPath}/moduleResources/sespct/js/mapIdentifiers.js" />
<script type="text/javascript">
    window.addEventListener("DOMContentLoaded", () => {
        new MapIdentifiers("#sespctPatient","#patientListTable", {locale: "${locale}", searchSuggestion: "${searchSuggestion}"});
    });
</script>
