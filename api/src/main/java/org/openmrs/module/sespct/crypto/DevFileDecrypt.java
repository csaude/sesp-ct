...
public final class DevFileDecrypt {
    ...
    public static void main(String[] args) throws Exception {
        ...
        PublicKey ctPublic = CtCompactCrypto.readPublicKeyPem(
                new String(Files.readAllBytes(ctPubFile.toPath()), StandardCharsets.UTF_8));
        PrivateKey clientPrivate = CtCompactCrypto.readPrivateKeyPem(
                new String(Files.readAllBytes(clientPrivFile.toPath()), StandardCharsets.UTF_8));
