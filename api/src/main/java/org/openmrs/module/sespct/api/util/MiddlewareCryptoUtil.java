 ...
 * Adapted for Java 8 from the provided CtCompactCrypto class. This is a stateless utility class
 * with static methods.
 */
public final class MiddlewareCryptoUtil {
	...
	public static PrivateKey readPrivateKeyPem(String pem) throws Exception {
		if (pem.contains("BEGIN RSA PRIVATE KEY")) {
			throw new IllegalArgumentException(
			        "PKCS#1 format detected. Please convert to PKCS#8: openssl pkcs8 -topk8 -in key.pem -out key_pkcs8.pem -nocrypt");
		}
	 ...
	 */
	public static boolean verifySignatureOverString(String dataB64, String signatureB64, PublicKey publicKey)
	        throws Exception {
