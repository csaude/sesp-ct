...
public class WebhookSubscriptionService {
	...
	private static final String E_WEBHOOKS = "/api/v1/webhooks";
	...
	public String createSubscription() throws Exception {
		...
		ResponseEntity<String> r = rest.postForEntity(cfg.getCtBaseUrl() + E_WEBHOOKS,
		    new HttpEntity<String>(body.toString(), h), String.class);
	...
	public void deleteSubscription(String subscriptionId) throws Exception {
		...
		rest.exchange(cfg.getCtBaseUrl() + E_WEBHOOKS, org.springframework.http.HttpMethod.DELETE, new HttpEntity<String>(
	...
	/**
	 * Encrypts clear bytes using AES-GCM (IV=12) and wraps the AES key with
	 * RSA-OAEP(SHA-256/MGF1-SHA-256), returns Base64(RSA||IV||CT).
	 */
